...
export default function HeroButton({
  ...
  const variants: Record<ButtonVariant, { base: string; hover: string }> = {
    ...
    secondary: {
      ...
      hover: "bg-white/20 border-[#C6A15B]/60 shadow-xl shadow-[#C6A15B]/40",
    },
    ghost: {
      base: "bg-white/5 backdrop-blur-xl border-2 border-[#C6A15B]/40 text-[#C6A15B]",
      hover: "border-[#C6A15B] bg-[#C6A15B]/15 shadow-lg shadow-[#C6A15B]/30",
    },
  };
  ...
  return (
    <div className="perspective-1000" style={{ perspective: "1200px" }}>
      <motion.button
        ...
        className={`relative overflow-hidden px-8 py-4 rounded-2xl font-semibold transition-all duration-300 ${selectedVariant.base} ${className}`}
        style={{
